...
namespace sga_stif.Models
{
    public class ContextoBaseDados : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TipologiaSocio>().HasData(
              ...
              new TipologiaSocio
              {
                  ...
                  Tipo = TipoTipologiaSocio.Honorario,
                  IdTipologiaSocio = 2,
                  Eliminado = true
              }
            ...
            var menus = new List<Menu>(){
              ...
              new Menu { IdMenu = 10, Nome = "Projeção de Quotas", Descricao = "Projeção de Quotas", IdMenuPai = null, NomeDaAction = "ListaProjecaoFluxo", NomeDoController = "ProjecaoFluxo", Icone = "fas fa-table" },
        ...
        //seed
        public static void SeedDados(ModelBuilder modelBuilder)
        {
