      ...
      namespace sga_stif.Controllers
      {
        ...
        public JsonResult GetEmployeeList() {
          ...
          public IActionResult EditaSocio(int idSocio, int idAgencia)
          {
            ...
            var angenciaListItem = from g in angencia select new SelectListItem { Value = g.IdAgencia.ToString(), Text = g.Cidade.Nome + " - " + g.Nome, Selected = agenciaAtul.IdAgencia == g.IdAgencia };
            var tipologiaSociosListItem = from g in tipologiaSocios select new SelectListItem { Value = g.IdTipologiaSocio.ToString(), Text = g.Descricao };
            var tipoQuotasListItem = from g in tipoQuotas select new SelectListItem { Value = g.IdTipoQuota.ToString(), Text = g.Descricao };
            ...
            var instituicaoFinanceirasItem = from g in instituicaoFinanceiras
                                             select new SelectListItem
                                             {
                                               ...
                                               Text = g.Nome,
                                               Selected = g.IdInstituicaoFinanceira == agenciaAtul.IdInstituicaoFinanceira
                                             };
